...
class AnalysisRefinementService:
    ...
    def generate_refinement_suggestions(self, analysis_text: str) -> list:
        ...
        """
        suggestions = [
            "Can you provide more specific examples from the conversation?",
            "What are the key action items or next steps?",
            "Can you focus on the emotional tone and sentiment?",
            "What are the main themes or topics discussed?",
